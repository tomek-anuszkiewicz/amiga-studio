//! M68000 EORI Instruction (`EORI #<data>, <ea>`)
//!
//! Performs bitwise Exclusive-OR of immediate data with a destination data register or alterable memory location.
...
pub static STEPS_EORI_B_D16_AN: [MicroStep; 10] = [
    MicroStep {
        bus_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(latch_imm_b),
        base_clocks: 2,
...
pub static STEPS_EORI_B_IDX_AN: [MicroStep; 11] = [
    MicroStep {
        bus_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(latch_imm_b),
        base_clocks: 2,
...
pub static STEPS_EORI_W_D16_AN: [MicroStep; 10] = [
    MicroStep {
        bus_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(latch_imm_w),
        base_clocks: 2,
...
pub static STEPS_EORI_W_IDX_AN: [MicroStep; 11] = [
    MicroStep {
        bus_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(latch_imm_w),
        base_clocks: 2,
...
pub static STEPS_EORI_L_D16_AN: [MicroStep; 16] = [
    MicroStep {
        bus_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_imm_l_hi),
        base_clocks: 2,
...
pub static STEPS_EORI_L_IDX_AN: [MicroStep; 17] = [
    MicroStep {
        bus_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_imm_l_hi),
        base_clocks: 2,
...
pub const fn decode_eori_steps(size: u8, mode: u8, reg: u8) -> Option<&'static [MicroStep]> {
    match size {
        0 => match mode {
            ...
            5 => Some(&STEPS_EORI_B_D16_AN),
            6 => Some(&STEPS_EORI_B_IDX_AN),
            7 => match reg {
        ...
        1 => match mode {
            ...
            5 => Some(&STEPS_EORI_W_D16_AN),
            6 => Some(&STEPS_EORI_W_IDX_AN),
            7 => match reg {
        ...
        2 => match mode {
            ...
            5 => Some(&STEPS_EORI_L_D16_AN),
            6 => Some(&STEPS_EORI_L_IDX_AN),
            7 => match reg {
