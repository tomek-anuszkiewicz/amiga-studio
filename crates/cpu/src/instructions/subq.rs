...
pub fn alu_subq_w_imm_an(state: &mut CpuState, imm: u8, reg_dst: u8) {
    ...
    state.set_a_long(reg_dst as usize, a.wrapping_sub(imm as u32));
}
...
pub static STEPS_SUBQ_B_AI: [MicroStep; 6] = [
    ...
    MicroStep {
        bus_fn: Some(Cpu::step_prefetch_next_read),
        alu_fn: Some(alu_subq_b_imm_mem),
        base_clocks: 2,
    },
...
pub static STEPS_SUBQ_W_AI: [MicroStep; 6] = [
    ...
    MicroStep {
        bus_fn: Some(Cpu::step_prefetch_next_read),
        alu_fn: Some(alu_subq_w_imm_mem),
        base_clocks: 2,
    },
    common::PREFETCH_IRC_FINISH,
    common::BUS_WRITE_IDLE,
...
pub static STEPS_SUBQ_L_AI: [MicroStep; 10] = [
    ...
    MicroStep {
        bus_fn: Some(Cpu::step_prefetch_next_read),
        alu_fn: Some(alu_subq_l_imm_mem),
        base_clocks: 2,
    },
    common::PREFETCH_IRC_FINISH,
    common::BUS_WRITE_IDLE,
