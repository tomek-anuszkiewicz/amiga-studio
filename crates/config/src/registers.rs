...
pub mod custom_reg {
    // --- Read-Only Status & Data Registers ($000 - $01E) ---
    ...
    // --- Disk Controller Strobe & Setup ($020 - $028) ---
    ...
    // --- Copper & Beam Position Control ($02A - $03E, $080 - $08C) ---
    ...
    // --- Blitter Coprocessor Registers ($040 - $076) ---
    ...
    // --- Bitplane Control & Modulos ($100 - $11A) ---
    ...
    // --- Sprite Pointers & Control ($120 - $17E) ---
    ...
    // --- Color Palette Registers ($180 - $1BE) ---
