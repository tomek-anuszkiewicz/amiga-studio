...
fn test_register_offsets_uniqueness_and_alignment() {
    ...
    let regs = [
        ...
        POTGOR, SERDATR, DSKBYTR, INTENAR, INTREQR, DSKPTH, DSKPTL, DSKLEN, DSKDAT, VPOSW, VHPOSW,
        COPCON, SERDAT, SERPER, POTGO, JOYTEST, STREQU, STRVBL, STRHOR, STRBUS, BLTCON0, BLTCON1,
        BLTAFWM, BLTALWM, BLTCPTH, BLTCPTL, BLTBPTH, BLTBPTL, BLTAPTH, BLTAPTL, BLTDPTH, BLTDPTL,
        BLTSIZE, BLTCMOD, BLTBMOD, BLTAMOD, BLTDMOD, BLTCDAT, BLTBDAT, BLTADAT, DSKSYNC, COP1LCH,
        COP1LCL, COP2LCH, COP2LCL, COPJMP1, COPJMP2, COPINS, DIWSTRT, DIWSTOP, DDFSTRT, DDFSTOP,
        DMACON, CLXCON, INTENA, INTREQ, ADKCON, AUD0PTH, AUD0PTL, AUD0LEN, AUD0PER, AUD0VOL,
        AUD0DAT, AUD1PTH, AUD1PTL, AUD1LEN, AUD1PER, AUD1VOL, AUD1DAT, AUD2PTH, AUD2PTL, AUD2LEN,
        AUD2PER, AUD2VOL, AUD2DAT, AUD3PTH, AUD3PTL, AUD3LEN, AUD3PER, AUD3VOL, AUD3DAT, BPL1PTH,
        BPL1PTL, BPL2PTH, BPL2PTL, BPL3PTH, BPL3PTL, BPL4PTH, BPL4PTL, BPL5PTH, BPL5PTL, BPL6PTH,
        BPL6PTL, BPLCON0, BPLCON1, BPLCON2, BPL1MOD, BPL2MOD, BPL1DAT, BPL2DAT, BPL3DAT, BPL4DAT,
        BPL5DAT, BPL6DAT, SPR0PTH, SPR0PTL, SPR0POS, SPR0CTL, SPR0DATA, SPR0DATB, COLOR00, COLOR01,
        COLOR31,
    ];
