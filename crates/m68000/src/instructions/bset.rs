...
pub static STEPS_BSET_DYN_DN: [MicroStep; 2] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_bset_l_dyn_dn), base_clocks: 4 },
];
pub static STEPS_BSET_DYN_AI: [MicroStep; 3] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_bset_b_dyn_mem), base_clocks: 4 },
...
pub static STEPS_BSET_STAT_DN: [MicroStep; 3] = [
    ...
    MicroStep { action: MicroAction::Alu, alu_fn: None, base_clocks: 4 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_bset_l_imm_dn), base_clocks: 4 },
];
pub static STEPS_BSET_STAT_AI: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::BusReadByte, alu_fn: None, base_clocks: 4 },
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_bset_b_imm_mem), base_clocks: 4 },
    common::RMW_WRITE_BYTE_RETIRE,
];
