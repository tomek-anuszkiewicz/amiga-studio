...
pub static STEPS_ANDI_B_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_andi_b_imm_dn), base_clocks: 4 },
...
pub static STEPS_ANDI_B_AI: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_andi_b_mem), base_clocks: 4 },
...
pub static STEPS_ANDI_W_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_andi_w_imm_dn), base_clocks: 4 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: None, base_clocks: 4 },
];
...
pub static STEPS_ANDI_W_AI: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_andi_w_mem), base_clocks: 4 },
...
pub static STEPS_ANDI_L_DN: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_andi_l_imm_dn), base_clocks: 4 },
];
...
pub static STEPS_ANDI_L_AI: [MicroStep; 7] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_andi_l_mem), base_clocks: 4 },
...
pub static STEPS_ANDI_CCR: [MicroStep; 1] = [MicroStep { action: MicroAction::AndiToCcr, alu_fn: None, base_clocks: 0 }];
pub static STEPS_ANDI_SR: [MicroStep; 1] = [MicroStep { action: MicroAction::AndiToSr, alu_fn: None, base_clocks: 0 }];
