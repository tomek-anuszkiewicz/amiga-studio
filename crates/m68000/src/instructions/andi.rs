...
pub static STEPS_ANDI_B_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_andi_b_imm_dn), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
...
pub static STEPS_ANDI_B_AI: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_andi_b_mem), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::BusWriteByteAndRetire, alu_fn: None, base_clocks: 4, flags: flags::WRITE | flags::DATA_SPACE },
];

pub static STEPS_ANDI_B_PI: [MicroStep; 4] = [
...
pub static STEPS_ANDI_B_PD: [MicroStep; 5] = [
...
pub static STEPS_ANDI_B_D16: [MicroStep; 5] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_b), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
...
pub static STEPS_ANDI_B_IDX: [MicroStep; 6] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_b), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
...
pub static STEPS_ANDI_B_ABSW: [MicroStep; 5] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_b), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
...
pub static STEPS_ANDI_B_ABSL: [MicroStep; 6] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_b), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
...
pub static STEPS_ANDI_W_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_andi_w_imm_dn), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
];

pub static STEPS_ANDI_W_AI: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_andi_w_mem), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::BusWriteWordAndRetire, alu_fn: None, base_clocks: 4, flags: flags::WRITE | flags::DATA_SPACE },
];

pub static STEPS_ANDI_W_PI: [MicroStep; 4] = [
...
pub static STEPS_ANDI_W_PD: [MicroStep; 5] = [
...
pub static STEPS_ANDI_W_D16: [MicroStep; 5] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_w), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_dst_d16_an), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::BusReadWord, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_andi_w_mem), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
...
pub static STEPS_ANDI_W_IDX: [MicroStep; 6] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_w), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::Alu, alu_fn: Some(ea::ea_calc_dst_idx_an), base_clocks: 2, flags: 0 },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::BusReadWord, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
...
pub static STEPS_ANDI_W_ABSW: [MicroStep; 5] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_w), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absw), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::BusReadWord, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_andi_w_mem), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
...
pub static STEPS_ANDI_W_ABSL: [MicroStep; 6] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_w), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absl_hi), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absl_lo), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::BusReadWord, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
...
pub static STEPS_ANDI_L_DN: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_andi_l_imm_dn), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
];

pub static STEPS_ANDI_L_AI: [MicroStep; 7] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_andi_l_mem), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
    common::RMW_WRITE_LONG_HIGH,
    common::RMW_WRITE_LONG_LOW_RETIRE,
];

pub static STEPS_ANDI_L_PI: [MicroStep; 7] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
...
pub static STEPS_ANDI_L_PD: [MicroStep; 8] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
...
pub static STEPS_ANDI_L_D16: [MicroStep; 8] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_l_lo), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_dst_d16_an), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::BusReadLongHigh, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
...
pub static STEPS_ANDI_L_IDX: [MicroStep; 9] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_l_lo), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::Alu, alu_fn: Some(ea::ea_calc_dst_idx_an), base_clocks: 2, flags: 0 },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
...
pub static STEPS_ANDI_L_ABSW: [MicroStep; 8] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_l_lo), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absw), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::BusReadLongHigh, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
...
pub static STEPS_ANDI_L_ABSL: [MicroStep; 9] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(crate::instructions::addi::latch_imm_l_lo), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absl_hi), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absl_lo), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
...
pub static STEPS_ANDI_CCR: [MicroStep; 1] = [MicroStep { action: MicroAction::AndiToCcr, alu_fn: None, base_clocks: 0, flags: flags::NONE }];
pub static STEPS_ANDI_SR: [MicroStep; 1] = [MicroStep { action: MicroAction::AndiToSr, alu_fn: None, base_clocks: 0, flags: flags::NONE }];
...
pub fn op_andi_b_imm_absl(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_b_imm_absw(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_b_imm_ai(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_b_imm_ccr(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi_to_ccr(cpu, bus) }
pub fn op_andi_b_imm_disp(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_b_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_b_imm_idx(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_b_imm_pd(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_b_imm_pi(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }

pub fn op_andi_l_imm_absl(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_l_imm_absw(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_l_imm_ai(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_l_imm_disp(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_l_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_l_imm_idx(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_l_imm_pd(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_l_imm_pi(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }

pub fn op_andi_w_imm_absl(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_w_imm_absw(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_w_imm_ai(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_w_imm_disp(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_w_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_w_imm_idx(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_w_imm_pd(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_w_imm_pi(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi(cpu, bus) }
pub fn op_andi_w_imm_sr(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_andi_to_sr(cpu, bus) }
