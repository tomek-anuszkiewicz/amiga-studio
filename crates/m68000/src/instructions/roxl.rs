...
pub static STEPS_ROXL_B_IMM: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxl_b_imm_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_ROXL_W_IMM: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxl_w_imm_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_ROXL_L_IMM: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxl_l_imm_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];

pub static STEPS_ROXL_B_REG: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxl_b_reg_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_ROXL_W_REG: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxl_w_reg_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_ROXL_L_REG: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxl_l_reg_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
...
pub static STEPS_ROXL_W_AI: [MicroStep; 6] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_scratch_read, alu_fn: Some(alu_roxl_w_mem), base_clocks: 2 },
...
pub static STEPS_ROXL_W_D16: [MicroStep; 8] = [
...
pub static STEPS_ROXL_W_IDX: [MicroStep; 9] = [
