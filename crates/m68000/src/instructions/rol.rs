...
pub static STEPS_ROL_W_AI: [MicroStep; 6] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_scratch_read, alu_fn: Some(alu_rol_w_mem), base_clocks: 2 },
...
pub static STEPS_ROL_W_D16: [MicroStep; 8] = [
...
pub static STEPS_ROL_W_IDX: [MicroStep; 9] = [
