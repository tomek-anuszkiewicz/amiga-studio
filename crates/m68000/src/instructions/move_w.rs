...
pub fn alu_move_w_dn_dst_ai(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    let val = (state.d_long(reg_src as usize) & 0xFFFF) as u16;
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
...
pub fn alu_move_w_dn_dst_pi(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    let val = (state.d_long(reg_src as usize) & 0xFFFF) as u16;
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
...
pub fn alu_move_w_dn_dst_pd(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    let val = (state.d_long(reg_src as usize) & 0xFFFF) as u16;
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
...
pub fn alu_move_w_an_dst_ai(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    let val = (state.read_a(reg_src as usize) & 0xFFFF) as u16;
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
    state.micro.ea_addr = state.read_a(reg_dst as usize);
...
pub fn alu_move_w_an_dst_pi(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    let val = (state.read_a(reg_src as usize) & 0xFFFF) as u16;
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
    let an = state.read_a(reg_dst as usize);
...
pub fn alu_move_w_an_dst_pd(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    let val = (state.read_a(reg_src as usize) & 0xFFFF) as u16;
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
    let an = state.read_a(reg_dst as usize).wrapping_sub(2);
...
pub fn alu_move_w_mem_dst_ai(state: &mut CpuState, _reg_src: u8, reg_dst: u8) {
    let val = (state.micro.source & 0xFFFF) as u16;
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
    state.micro.ea_addr = state.read_a(reg_dst as usize);
...
pub fn alu_move_w_mem_dst_pi(state: &mut CpuState, _reg_src: u8, reg_dst: u8) {
    let val = (state.micro.source & 0xFFFF) as u16;
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
    let an = state.read_a(reg_dst as usize);
...
pub fn alu_move_w_mem_dst_pd(state: &mut CpuState, _reg_src: u8, reg_dst: u8) {
    let val = (state.micro.source & 0xFFFF) as u16;
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
    let an = state.read_a(reg_dst as usize).wrapping_sub(2);
...
pub fn alu_move_w_imm_dst_ai(state: &mut CpuState, _reg_src: u8, reg_dst: u8) {
    let val = state.prefetch[0];
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
    state.micro.ea_addr = state.read_a(reg_dst as usize);
...
pub fn alu_move_w_imm_dst_pi(state: &mut CpuState, _reg_src: u8, reg_dst: u8) {
    let val = state.prefetch[0];
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
    let an = state.read_a(reg_dst as usize);
...
pub fn alu_move_w_imm_dst_pd(state: &mut CpuState, _reg_src: u8, reg_dst: u8) {
    let val = state.prefetch[0];
    state.set_ccr_nz_clear_vc((val as i16) < 0, val == 0);
    state.micro.destination = val as u32;
    let an = state.read_a(reg_dst as usize).wrapping_sub(2);
...
const READ_SRC_IDLE_MOVE_W: MicroStep = MicroStep {
    step_fn: None,
    alu_fn: Some(alu_move_w_src_mem),
    base_clocks: 2,
};
...
pub fn alu_move_w_dn_ea_d16_an(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    alu_move_w_src_dn(state, reg_src, reg_dst);
    ea::ea_calc_dst_d16_an(state, reg_src, reg_dst);
}
pub fn alu_move_w_dn_ea_idx_an(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    alu_move_w_src_dn(state, reg_src, reg_dst);
    ea::ea_calc_dst_idx_an(state, reg_src, reg_dst);
}
pub fn alu_move_w_dn_ea_absw(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    alu_move_w_src_dn(state, reg_src, reg_dst);
    ea::ea_calc_absw(state, reg_src, reg_dst);
}
pub fn alu_move_w_dn_ea_absl_hi(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    alu_move_w_src_dn(state, reg_src, reg_dst);
    ea::ea_calc_absl_hi(state, reg_src, reg_dst);
}

pub fn alu_move_w_an_ea_d16_an(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    alu_move_w_src_an(state, reg_src, reg_dst);
    ea::ea_calc_dst_d16_an(state, reg_src, reg_dst);
}
pub fn alu_move_w_an_ea_idx_an(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    alu_move_w_src_an(state, reg_src, reg_dst);
    ea::ea_calc_dst_idx_an(state, reg_src, reg_dst);
}
pub fn alu_move_w_an_ea_absw(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    alu_move_w_src_an(state, reg_src, reg_dst);
    ea::ea_calc_absw(state, reg_src, reg_dst);
}
pub fn alu_move_w_an_ea_absl_hi(state: &mut CpuState, reg_src: u8, reg_dst: u8) {
    alu_move_w_src_an(state, reg_src, reg_dst);
    ea::ea_calc_absl_hi(state, reg_src, reg_dst);
}
...
pub static STEPS_MOVE_W_DN_PI: [MicroStep; 4] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(alu_move_w_dn_dst_pi),
        base_clocks: 2,
    },
    WRITE_DST_WORD,
    PREFETCH_NEXT_READ,
...
pub static STEPS_MOVE_W_DN_PD: [MicroStep; 4] = [
    MicroStep {
        step_fn: Some(Cpu::step_prefetch_next_read),
        alu_fn: Some(alu_move_w_dn_dst_pd),
        base_clocks: 2,
    },
    PREFETCH_IRC_FINISH,
    BUS_WRITE_IDLE,
...
pub static STEPS_MOVE_W_DN_D16_AN: [MicroStep; 6] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(alu_move_w_dn_ea_d16_an),
        base_clocks: 2,
    },
    FETCH_EXT_FINISH,
    BUS_WRITE_IDLE,
...
pub static STEPS_MOVE_W_DN_IDX_AN: [MicroStep; 7] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(alu_move_w_dn_ea_idx_an),
        base_clocks: 2,
    },
    FETCH_EXT_READ,
    FETCH_EXT_FINISH,
...
pub static STEPS_MOVE_W_DN_ABSW: [MicroStep; 6] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(alu_move_w_dn_ea_absw),
        base_clocks: 2,
    },
    FETCH_EXT_FINISH,
    BUS_WRITE_IDLE,
...
pub static STEPS_MOVE_W_DN_ABSL: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(alu_move_w_dn_ea_absl_hi),
        base_clocks: 2,
    },
    FETCH_EXT_FINISH,
    MicroStep {
...
pub static STEPS_MOVE_W_AN_AI: [MicroStep; 4] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(alu_move_w_an_dst_ai),
        base_clocks: 2,
    },
    WRITE_DST_WORD,
    PREFETCH_NEXT_READ,
...
pub static STEPS_MOVE_W_AN_PI: [MicroStep; 4] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(alu_move_w_an_dst_pi),
        base_clocks: 2,
    },
    WRITE_DST_WORD,
    PREFETCH_NEXT_READ,
...
pub static STEPS_MOVE_W_AN_PD: [MicroStep; 4] = [
    MicroStep {
        step_fn: Some(Cpu::step_prefetch_next_read),
        alu_fn: Some(alu_move_w_an_dst_pd),
        base_clocks: 2,
    },
    PREFETCH_IRC_FINISH,
    BUS_WRITE_IDLE,
...
pub static STEPS_MOVE_W_AN_D16_AN: [MicroStep; 6] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(alu_move_w_an_ea_d16_an),
        base_clocks: 2,
    },
    FETCH_EXT_FINISH,
    BUS_WRITE_IDLE,
...
pub static STEPS_MOVE_W_AN_IDX_AN: [MicroStep; 7] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(alu_move_w_an_ea_idx_an),
        base_clocks: 2,
    },
    FETCH_EXT_READ,
    FETCH_EXT_FINISH,
...
pub static STEPS_MOVE_W_AN_ABSW: [MicroStep; 6] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(alu_move_w_an_ea_absw),
        base_clocks: 2,
    },
    FETCH_EXT_FINISH,
    BUS_WRITE_IDLE,
...
pub static STEPS_MOVE_W_AN_ABSL: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(alu_move_w_an_ea_absl_hi),
        base_clocks: 2,
    },
    FETCH_EXT_FINISH,
    MicroStep {
...
pub static STEPS_MOVE_W_AI_AI: [MicroStep; 6] = [
    ...
    MicroStep {
        step_fn: None,
        alu_fn: Some(alu_move_w_mem_dst_ai),
        base_clocks: 2,
    },
    WRITE_DST_WORD,
    PREFETCH_NEXT_READ,
...
pub static STEPS_MOVE_W_AI_PI: [MicroStep; 6] = [
    ...
    MicroStep {
        step_fn: None,
        alu_fn: Some(alu_move_w_mem_dst_pi),
        base_clocks: 2,
    },
    WRITE_DST_WORD,
    PREFETCH_NEXT_READ,
...
pub static STEPS_MOVE_W_AI_PD: [MicroStep; 6] = [
    ...
    MicroStep {
        step_fn: Some(Cpu::step_prefetch_next_read),
        alu_fn: Some(alu_move_w_mem_dst_pd),
        base_clocks: 2,
    },
    PREFETCH_IRC_FINISH,
    BUS_WRITE_IDLE,
...
pub static STEPS_MOVE_W_AI_D16_AN: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_bus_read_src_word),
        alu_fn: Some(ea::ea_calc_src_ai),
        base_clocks: 2,
    },
    READ_SRC_IDLE_MOVE_W,
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
...
pub static STEPS_MOVE_W_AI_IDX_AN: [MicroStep; 9] = [
    MicroStep {
        step_fn: Some(Cpu::step_bus_read_src_word),
        alu_fn: Some(ea::ea_calc_src_ai),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_AI_ABSW: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_bus_read_src_word),
        alu_fn: Some(ea::ea_calc_src_ai),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_AI_ABSL: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_bus_read_src_word),
        alu_fn: Some(ea::ea_calc_src_ai),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_PI_D16_AN: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_bus_read_src_word),
        alu_fn: Some(ea::ea_calc_src_pi_w),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_PI_IDX_AN: [MicroStep; 9] = [
    MicroStep {
        step_fn: Some(Cpu::step_bus_read_src_word),
        alu_fn: Some(ea::ea_calc_src_pi_w),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_PI_ABSW: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_bus_read_src_word),
        alu_fn: Some(ea::ea_calc_src_pi_w),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_PI_ABSL: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_bus_read_src_word),
        alu_fn: Some(ea::ea_calc_src_pi_w),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_PD_AI: [MicroStep; 7] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_pd_w),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_PD_PI: [MicroStep; 7] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_pd_w),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_PD_PD: [MicroStep; 7] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_pd_w),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_PD_D16_AN: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_pd_w),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_PD_IDX_AN: [MicroStep; 10] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_pd_w),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_PD_ABSW: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_pd_w),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_PD_ABSL: [MicroStep; 11] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_pd_w),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_AN_AI: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_src_d16_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_AN_PI: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_src_d16_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_AN_PD: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_src_d16_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_AN_D16_AN: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_src_d16_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_AN_IDX_AN: [MicroStep; 11] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_src_d16_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_AN_ABSW: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_src_d16_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_AN_ABSL: [MicroStep; 12] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_src_d16_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_AN_AI: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_idx_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_AN_PI: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_idx_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_AN_PD: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_idx_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_AN_D16_AN: [MicroStep; 11] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_idx_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_AN_IDX_AN: [MicroStep; 12] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_idx_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_AN_ABSW: [MicroStep; 11] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_idx_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_AN_ABSL: [MicroStep; 13] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_idx_an),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSW_AI: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absw),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSW_PI: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absw),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSW_PD: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absw),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSW_D16_AN: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absw),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSW_IDX_AN: [MicroStep; 11] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absw),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSW_ABSW: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absw),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSW_ABSL: [MicroStep; 12] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absw),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSL_AI: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absl_hi),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSL_PI: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absl_hi),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSL_PD: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absl_hi),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSL_D16_AN: [MicroStep; 12] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absl_hi),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSL_IDX_AN: [MicroStep; 13] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absl_hi),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSL_ABSW: [MicroStep; 12] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absl_hi),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_ABSL_ABSL: [MicroStep; 14] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_absl_hi),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_PC_AI: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_d16_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_PC_PI: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_d16_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_PC_PD: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_d16_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_PC_D16_AN: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_d16_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_PC_IDX_AN: [MicroStep; 11] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_d16_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_PC_ABSW: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_d16_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_D16_PC_ABSL: [MicroStep; 12] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_d16_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_PC_AI: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_idx_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_PC_PI: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_idx_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_PC_PD: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_idx_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_PC_D16_AN: [MicroStep; 11] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_idx_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_PC_IDX_AN: [MicroStep; 12] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_idx_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_PC_ABSW: [MicroStep; 11] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_idx_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IDX_PC_ABSL: [MicroStep; 13] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_idx_pc),
        base_clocks: 2,
...
pub static STEPS_MOVE_W_IMM_AI: [MicroStep; 6] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
...
pub static STEPS_MOVE_W_IMM_PI: [MicroStep; 6] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(alu_move_w_src_imm),
        base_clocks: 2,
    ...
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_move_dst_pi_w),
        base_clocks: 2,
    },
    WRITE_DST_WORD,
    PREFETCH_NEXT_READ,
...
pub static STEPS_MOVE_W_IMM_PD: [MicroStep; 6] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(alu_move_w_src_imm),
        base_clocks: 2,
