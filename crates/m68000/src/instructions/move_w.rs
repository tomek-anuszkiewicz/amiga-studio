...
const READ_OP: MicroStep = MicroStep { action: MicroAction::BusReadWord, alu_fn: None, base_clocks: 4 };
const WRITE_OP: MicroStep = MicroStep { action: MicroAction::BusWriteWord, alu_fn: None, base_clocks: 4 };
const WRITE_OP_RETIRE: MicroStep = MicroStep { action: MicroAction::BusWriteWordAndRetire, alu_fn: None, base_clocks: 4 };
...
pub static STEPS_MOVE_W_DN_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_move_w_dn_dn), base_clocks: 4 },
];
...
pub static STEPS_MOVE_W_DN_D16: [MicroStep; 4] = [
    MicroStep::alu(alu_move_w_src_dn), MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_dst_d16_an), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_DN_IDX: [MicroStep; 5] = [
    MicroStep::alu(alu_move_w_src_dn), MicroStep { action: MicroAction::Alu, alu_fn: Some(ea::ea_calc_dst_idx_an), base_clocks: 2 },
    FETCH_EXT, WRITE_OP,
    PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_DN_ABSW: [MicroStep; 4] = [
    MicroStep::alu(alu_move_w_src_dn), MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absw), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_DN_ABSL: [MicroStep; 5] = [
    MicroStep::alu(alu_move_w_src_dn), MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absl_hi), base_clocks: 4 },
...
pub static STEPS_MOVE_W_AN_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_move_w_an_dn), base_clocks: 4 },
];
...
pub static STEPS_MOVE_W_AN_D16: [MicroStep; 4] = [
    MicroStep::alu(alu_move_w_src_an), MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_dst_d16_an), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_AN_IDX: [MicroStep; 5] = [
    MicroStep::alu(alu_move_w_src_an), MicroStep { action: MicroAction::Alu, alu_fn: Some(ea::ea_calc_dst_idx_an), base_clocks: 2 },
    FETCH_EXT, WRITE_OP,
    PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_AN_ABSW: [MicroStep; 4] = [
    MicroStep::alu(alu_move_w_src_an), MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absw), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_AN_ABSL: [MicroStep; 5] = [
    MicroStep::alu(alu_move_w_src_an), MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absl_hi), base_clocks: 4 },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absl_lo), base_clocks: 4 }, WRITE_OP,
    PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_AI_DN: [MicroStep; 3] = [
    MicroStep::alu(ea::ea_calc_src_ai), READ_OP,
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_move_w_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_MOVE_W_AI_D16: [MicroStep; 6] = [
    MicroStep::alu(ea::ea_calc_src_ai), READ_OP,
    MicroStep::alu(alu_move_w_src_mem), MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_dst_d16_an), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_AI_IDX: [MicroStep; 7] = [
    MicroStep::alu(ea::ea_calc_src_ai), READ_OP,
    MicroStep::alu(alu_move_w_src_mem), MicroStep { action: MicroAction::Alu, alu_fn: Some(ea::ea_calc_dst_idx_an), base_clocks: 2 },
    FETCH_EXT, WRITE_OP,
    PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_AI_ABSW: [MicroStep; 6] = [
    MicroStep::alu(ea::ea_calc_src_ai), READ_OP,
    MicroStep::alu(alu_move_w_src_mem), MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absw), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_AI_ABSL: [MicroStep; 7] = [
    MicroStep::alu(ea::ea_calc_src_ai), READ_OP,
    MicroStep::alu(alu_move_w_src_mem), MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absl_hi), base_clocks: 4 },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absl_lo), base_clocks: 4 }, WRITE_OP,
    PREFETCH_RETIRE,
];
...
pub static STEPS_MOVE_W_PD_DN: [MicroStep; 3] = [
    MicroStep { action: MicroAction::Alu, alu_fn: Some(ea::ea_calc_src_pd_w), base_clocks: 2 }, READ_OP,
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_move_w_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_MOVE_W_IDX_DN: [MicroStep; 4] = [
    ...
    READ_OP, MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_move_w_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_MOVE_W_IMM_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_move_w_imm_dn), base_clocks: 4 }, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_IMM_AI: [MicroStep; 4] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_move_w_src_imm), base_clocks: 4 }, MicroStep::alu(ea::ea_calc_dst_ai),
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_IMM_PI: [MicroStep; 4] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_move_w_src_imm), base_clocks: 4 }, MicroStep::alu(ea::ea_calc_move_dst_pi_w),
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_IMM_PD: [MicroStep; 4] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_move_w_src_imm), base_clocks: 4 }, MicroStep::alu(ea::ea_calc_dst_pd_w),
    PREFETCH_SCRATCH, WRITE_OP_RETIRE,
];
pub static STEPS_MOVE_W_IMM_D16: [MicroStep; 4] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_move_w_src_imm), base_clocks: 4 }, MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_dst_d16_an), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_IMM_IDX: [MicroStep; 5] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_move_w_src_imm), base_clocks: 4 }, MicroStep { action: MicroAction::Alu, alu_fn: Some(ea::ea_calc_dst_idx_an), base_clocks: 2 },
    FETCH_EXT, WRITE_OP,
    PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_IMM_ABSW: [MicroStep; 4] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_move_w_src_imm), base_clocks: 4 }, MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absw), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_W_IMM_ABSL: [MicroStep; 5] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_move_w_src_imm), base_clocks: 4 }, MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absl_hi), base_clocks: 4 },
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(ea::ea_calc_absl_lo), base_clocks: 4 }, WRITE_OP,
    PREFETCH_RETIRE,
];
