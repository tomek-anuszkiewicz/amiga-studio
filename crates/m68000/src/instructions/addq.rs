...
pub static STEPS_ADDQ_B_DN: [MicroStep; 1] = [
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_addq_b_imm_dn), base_clocks: 4 },
];
pub static STEPS_ADDQ_W_DN: [MicroStep; 1] = [
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_addq_w_imm_dn), base_clocks: 4 },
];
pub static STEPS_ADDQ_L_DN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: None, base_clocks: 4 },
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_addq_l_imm_dn), base_clocks: 4 },
];
pub static STEPS_ADDQ_W_AN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: None, base_clocks: 4 },
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_addq_w_imm_an), base_clocks: 4 },
];
pub static STEPS_ADDQ_L_AN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: None, base_clocks: 4 },
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_addq_l_imm_an), base_clocks: 4 },
];
...
pub static STEPS_ADDQ_B_AI: [MicroStep; 3] = [
    ...
    MicroStep { step_fn: Cpu::step_bus_prefetch_to_scratch, alu_fn: Some(alu_addq_b_imm_mem), base_clocks: 4 },
...
pub static STEPS_ADDQ_W_AI: [MicroStep; 3] = [
    ...
    MicroStep { step_fn: Cpu::step_bus_prefetch_to_scratch, alu_fn: Some(alu_addq_w_imm_mem), base_clocks: 4 },
...
pub static STEPS_ADDQ_L_AI: [MicroStep; 5] = [
    ...
    MicroStep { step_fn: Cpu::step_bus_prefetch_to_scratch, alu_fn: Some(alu_addq_l_imm_mem), base_clocks: 4 },
