...
pub static STEPS_ADDQ_B_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_addq_b_imm_dn), base_clocks: 4 },
];
pub static STEPS_ADDQ_W_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_addq_w_imm_dn), base_clocks: 4 },
];
pub static STEPS_ADDQ_L_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: None, base_clocks: 4 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_addq_l_imm_dn), base_clocks: 4 },
];
pub static STEPS_ADDQ_W_AN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: None, base_clocks: 4 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_addq_w_imm_an), base_clocks: 4 },
];
pub static STEPS_ADDQ_L_AN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: None, base_clocks: 4 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_addq_l_imm_an), base_clocks: 4 },
];
...
pub static STEPS_ADDQ_B_AI: [MicroStep; 3] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_addq_b_imm_mem), base_clocks: 4 },
...
pub static STEPS_ADDQ_W_AI: [MicroStep; 3] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_addq_w_imm_mem), base_clocks: 4 },
...
pub static STEPS_ADDQ_L_AI: [MicroStep; 5] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_addq_l_imm_mem), base_clocks: 4 },
