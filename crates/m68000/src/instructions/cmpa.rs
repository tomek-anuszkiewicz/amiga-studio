...
pub static STEPS_CMPA_W_DN_AN: [MicroStep; 2] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_cmpa_w_dn_an), base_clocks: 4 },
];
pub static STEPS_CMPA_W_AN_AN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: None, base_clocks: 2 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_cmpa_w_an_an), base_clocks: 4 },
];
pub static STEPS_CMPA_W_AI_AN: [MicroStep; 2] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_cmpa_w_mem_an), base_clocks: 4 },
];
...
pub static STEPS_CMPA_W_IMM_AN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_cmpa_w_imm_an), base_clocks: 4 },
...
pub static STEPS_CMPA_L_DN_AN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: None, base_clocks: 2 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_cmpa_l_dn_an), base_clocks: 4 },
];
pub static STEPS_CMPA_L_AN_AN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: None, base_clocks: 2 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_cmpa_l_an_an), base_clocks: 4 },
];
pub static STEPS_CMPA_L_AI_AN: [MicroStep; 3] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_cmpa_l_mem_an), base_clocks: 4 },
];
