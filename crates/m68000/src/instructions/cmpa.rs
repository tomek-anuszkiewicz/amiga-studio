...
pub static STEPS_CMPA_W_DN_AN: [MicroStep; 3] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_cmpa_w_dn_an), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_CMPA_W_AN_AN: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: None, base_clocks: 2 },
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_cmpa_w_an_an), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_CMPA_W_AI_AN: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_bus_read_src_word, alu_fn: Some(ea::ea_calc_src_ai), base_clocks: 2 },
    common::READ_WORD_FINISH,
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_cmpa_w_mem_an), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_CMPA_W_PI_AN: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_bus_read_src_word, alu_fn: Some(ea::ea_calc_src_pi_w), base_clocks: 2 },
    common::READ_WORD_FINISH,
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_cmpa_w_mem_an), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_CMPA_W_PD_AN: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_bus_read_src_word, alu_fn: Some(ea::ea_calc_src_pd_w), base_clocks: 2 },
    common::READ_WORD_FINISH,
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_cmpa_w_mem_an), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_CMPA_W_D16_AN: [MicroStep; 6] = [
...
pub static STEPS_CMPA_W_IDX_AN: [MicroStep; 7] = [
...
pub static STEPS_CMPA_W_ABSW_AN: [MicroStep; 6] = [
...
pub static STEPS_CMPA_W_ABSL_AN: [MicroStep; 8] = [
...
pub static STEPS_CMPA_W_D16PC_AN: [MicroStep; 6] = [
...
pub static STEPS_CMPA_W_IDXPC_AN: [MicroStep; 7] = [
...
pub static STEPS_CMPA_W_IMM_AN: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(alu_cmpa_w_imm_an), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_CMPA_L_DN_AN: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: None, base_clocks: 2 },
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_cmpa_l_dn_an), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_CMPA_L_AN_AN: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: None, base_clocks: 2 },
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_cmpa_l_an_an), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_CMPA_L_AI_AN: [MicroStep; 6] = [
    MicroStep { step_fn: Cpu::step_bus_read_src_long_high, alu_fn: Some(ea::ea_calc_src_ai), base_clocks: 2 },
    common::READ_WORD_FINISH,
    common::READ_SRC_LONG_LOW,
    common::READ_WORD_FINISH,
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_cmpa_l_mem_an), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_CMPA_L_PI_AN: [MicroStep; 6] = [
...
pub static STEPS_CMPA_L_PD_AN: [MicroStep; 6] = [
...
pub static STEPS_CMPA_L_D16_AN: [MicroStep; 8] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_src_d16_an), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_CMPA_L_IDX_AN: [MicroStep; 9] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_src_idx_an), base_clocks: 2 },
    common::FETCH_EXT_READ,
    common::FETCH_EXT_FINISH,
    common::READ_SRC_LONG_HIGH,
...
pub static STEPS_CMPA_L_ABSW_AN: [MicroStep; 8] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_absw), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    common::READ_SRC_LONG_HIGH,
    common::READ_WORD_FINISH,
...
pub static STEPS_CMPA_L_ABSL_AN: [MicroStep; 10] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_absl_hi), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_absl_lo), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_CMPA_L_D16PC_AN: [MicroStep; 8] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_d16_pc), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    common::READ_SRC_LONG_HIGH,
    common::READ_WORD_FINISH,
...
pub static STEPS_CMPA_L_IDXPC_AN: [MicroStep; 9] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_idx_pc), base_clocks: 2 },
    common::FETCH_EXT_READ,
    common::FETCH_EXT_FINISH,
    common::READ_SRC_LONG_HIGH,
...
pub static STEPS_CMPA_L_IMM_AN: [MicroStep; 6] = [
