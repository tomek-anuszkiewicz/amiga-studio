...
pub static STEPS_TST_B_DN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_tst_b_dn), base_clocks: 2 },
...
pub static STEPS_TST_B_AI: [MicroStep; 4] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_tst_b_mem), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
...
pub static STEPS_TST_B_IDX: [MicroStep; 7] = [
...
pub static STEPS_TST_B_PCD16: [MicroStep; 6] = [
...
pub static STEPS_TST_B_PCIDX: [MicroStep; 7] = [
...
pub static STEPS_TST_W_DN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_tst_w_dn), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_TST_W_AI: [MicroStep; 4] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_tst_w_mem), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
...
pub static STEPS_TST_W_IDX: [MicroStep; 7] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_src_idx_an), base_clocks: 2 },
    common::FETCH_EXT_READ,
    common::FETCH_EXT_FINISH,
    common::READ_SRC_WORD,
...
pub static STEPS_TST_W_PCD16: [MicroStep; 6] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_d16_pc), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    common::READ_SRC_WORD,
    common::READ_WORD_FINISH,
...
pub static STEPS_TST_W_PCIDX: [MicroStep; 7] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_idx_pc), base_clocks: 2 },
    common::FETCH_EXT_READ,
    common::FETCH_EXT_FINISH,
    common::READ_SRC_WORD,
...
pub static STEPS_TST_L_DN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_tst_l_dn), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_TST_L_AI: [MicroStep; 6] = [
    ...
    common::READ_WORD_FINISH,
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_tst_l_mem), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
...
pub static STEPS_TST_L_PD: [MicroStep; 6] = [
...
pub static STEPS_TST_L_D16: [MicroStep; 8] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_src_d16_an), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_TST_L_IDX: [MicroStep; 9] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_src_idx_an), base_clocks: 2 },
    common::FETCH_EXT_READ,
    common::FETCH_EXT_FINISH,
    common::READ_SRC_LONG_HIGH,
...
pub static STEPS_TST_L_PCD16: [MicroStep; 8] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_d16_pc), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    common::READ_SRC_LONG_HIGH,
    common::READ_WORD_FINISH,
...
pub static STEPS_TST_L_PCIDX: [MicroStep; 9] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_idx_pc), base_clocks: 2 },
    common::FETCH_EXT_READ,
    common::FETCH_EXT_FINISH,
    common::READ_SRC_LONG_HIGH,
