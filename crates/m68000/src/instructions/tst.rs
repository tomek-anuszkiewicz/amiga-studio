...
pub static STEPS_TST_B_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_tst_b_dn), base_clocks: 4 },
];
pub static STEPS_TST_B_AI: [MicroStep; 2] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_tst_b_mem), base_clocks: 4 },
];
...
pub static STEPS_TST_W_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_tst_w_dn), base_clocks: 4 },
];
pub static STEPS_TST_W_AI: [MicroStep; 2] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_tst_w_mem), base_clocks: 4 },
];
...
pub static STEPS_TST_L_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_tst_l_dn), base_clocks: 4 },
];
pub static STEPS_TST_L_AI: [MicroStep; 3] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_tst_l_mem), base_clocks: 4 },
];
