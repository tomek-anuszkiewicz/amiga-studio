...
pub static STEPS_ADDX_B_DN_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_addx_b_dn_dn), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
];

pub static STEPS_ADDX_W_DN_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_addx_w_dn_dn), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
];

pub static STEPS_ADDX_L_DN_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: None, base_clocks: 4, flags: 0 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_addx_l_dn_dn), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
];

pub static STEPS_ADDX_B_PD_PD: [MicroStep; 5] = [
    MicroStep { action: MicroAction::Alu, alu_fn: Some(ea_calc_src_pd_b_2clocks), base_clocks: 2, flags: 0 },
    MicroStep { action: MicroAction::BusReadByte, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
    MicroStep { action: MicroAction::BusReadByte, alu_fn: Some(latch_src_b_and_calc_dst_pd_b), base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_addx_b_mem), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
...
pub static STEPS_ADDX_W_PD_PD: [MicroStep; 5] = [
    MicroStep { action: MicroAction::Alu, alu_fn: Some(ea_calc_src_pd_w_2clocks), base_clocks: 2, flags: 0 },
    MicroStep { action: MicroAction::BusReadWord, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
    MicroStep { action: MicroAction::BusReadWord, alu_fn: Some(latch_src_w_and_calc_dst_pd_w), base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_addx_w_mem), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
...
pub static STEPS_ADDX_L_PD_PD: [MicroStep; 8] = [
    MicroStep { action: MicroAction::Alu, alu_fn: Some(ea_calc_src_pd_l_2clocks), base_clocks: 2, flags: 0 },
    MicroStep { action: MicroAction::BusReadWord, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
    MicroStep { action: MicroAction::BusReadWord, alu_fn: Some(latch_src_lo_and_read_src_hi), base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
    MicroStep { action: MicroAction::BusReadWord, alu_fn: Some(latch_src_hi_and_calc_dst_pd_l), base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
    MicroStep { action: MicroAction::BusReadWord, alu_fn: Some(latch_dst_lo_and_read_dst_hi), base_clocks: 4, flags: flags::READ | flags::DATA_SPACE },
    MicroStep { action: MicroAction::BusWriteWord, alu_fn: Some(latch_dst_and_calc_addx_l), base_clocks: 4, flags: flags::WRITE | flags::DATA_SPACE },
    ...
    MicroStep { action: MicroAction::BusWriteWordAndRetire, alu_fn: Some(set_write_hi), base_clocks: 4, flags: flags::WRITE | flags::DATA_SPACE },
];
