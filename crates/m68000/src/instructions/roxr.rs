...
pub static STEPS_ROXR_B_IMM: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxr_b_imm_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_ROXR_W_IMM: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxr_w_imm_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_ROXR_L_IMM: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxr_l_imm_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];

pub static STEPS_ROXR_B_REG: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxr_b_reg_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_ROXR_W_REG: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxr_w_reg_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_ROXR_L_REG: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_roxr_l_reg_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
...
pub static STEPS_ROXR_W_AI: [MicroStep; 6] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_scratch_read, alu_fn: Some(alu_roxr_w_mem), base_clocks: 2 },
...
pub static STEPS_ROXR_W_D16: [MicroStep; 8] = [
...
pub static STEPS_ROXR_W_IDX: [MicroStep; 9] = [
