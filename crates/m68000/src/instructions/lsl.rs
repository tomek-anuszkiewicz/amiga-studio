...
pub fn lsl_b(state: &mut CpuState, count: u32, val: u8) -> u8 {
    ...
    state.set_ccr_xnzvc(last_out, new_msb, v == 0, false, last_out);
    v
}
...
pub static STEPS_LSL_B_IMM: [MicroStep; 3] = [
    MicroStep::alu(alu_lsl_b_imm_dn),
    common::PREFETCH_NEXT_READ,
    common::BUS_READ_IDLE,
];
pub static STEPS_LSL_W_IMM: [MicroStep; 3] = [
    MicroStep::alu(alu_lsl_w_imm_dn),
    common::PREFETCH_NEXT_READ,
    common::BUS_READ_IDLE,
];
pub static STEPS_LSL_L_IMM: [MicroStep; 3] = [
    MicroStep::alu(alu_lsl_l_imm_dn),
    common::PREFETCH_NEXT_READ,
    common::BUS_READ_IDLE,
];

pub static STEPS_LSL_B_REG: [MicroStep; 3] = [
    MicroStep::alu(alu_lsl_b_reg_dn),
    common::PREFETCH_NEXT_READ,
    common::BUS_READ_IDLE,
];
pub static STEPS_LSL_W_REG: [MicroStep; 3] = [
    MicroStep::alu(alu_lsl_w_reg_dn),
    common::PREFETCH_NEXT_READ,
    common::BUS_READ_IDLE,
];
pub static STEPS_LSL_L_REG: [MicroStep; 3] = [
    MicroStep::alu(alu_lsl_l_reg_dn),
    common::PREFETCH_NEXT_READ,
    common::BUS_READ_IDLE,
];
...
pub static STEPS_LSL_W_AI: [MicroStep; 6] = [
    MicroStep {
...
pub static STEPS_LSL_W_PI: [MicroStep; 6] = [
    MicroStep {
        bus_fn: Some(Cpu::step_bus_read_dst_word),
...
pub static STEPS_LSL_W_PD: [MicroStep; 6] = [
    MicroStep {
        bus_fn: Some(Cpu::step_bus_read_dst_word),
...
pub static STEPS_LSL_W_D16_AN: [MicroStep; 8] = [
    MicroStep {
...
pub static STEPS_LSL_W_IDX_AN: [MicroStep; 9] = [
    MicroStep {
        bus_fn: None,
...
pub static STEPS_LSL_W_ABSW: [MicroStep; 8] = [
    MicroStep {
        bus_fn: Some(Cpu::step_fetch_extension_read),
...
pub static STEPS_LSL_W_ABSL: [MicroStep; 10] = [
    MicroStep {
        bus_fn: Some(Cpu::step_fetch_extension_read),
...
pub const fn decode_lsl_mem_steps(mode: u8, reg: u8) -> Option<&'static [MicroStep]> {
    match mode {
        ...
        5 => Some(&STEPS_LSL_W_D16_AN),
        6 => Some(&STEPS_LSL_W_IDX_AN),
        7 => match reg {
