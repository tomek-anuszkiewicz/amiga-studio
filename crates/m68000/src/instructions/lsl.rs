...
pub static STEPS_LSL_W_AI: [MicroStep; 6] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_scratch_read, alu_fn: Some(alu_lsl_w_mem), base_clocks: 2 },
...
pub static STEPS_LSL_W_D16: [MicroStep; 8] = [
...
pub static STEPS_LSL_W_IDX: [MicroStep; 9] = [
