...
pub static STEPS_BCHG_DYN_AI: [MicroStep; 6] = [
    ...
    MicroStep {
        step_fn: Some(Cpu::step_prefetch_next_read),
        alu_fn: Some(alu_bchg_b_dyn_mem),
        base_clocks: 2,
    },
...
pub static STEPS_BCHG_DYN_D16_AN: [MicroStep; 8] = [
    MicroStep {
...
pub static STEPS_BCHG_DYN_IDX_AN: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
...
pub static STEPS_BCHG_STAT_AI: [MicroStep; 8] = [
    ...
    MicroStep {
        step_fn: Some(Cpu::step_prefetch_next_read),
        alu_fn: Some(alu_bchg_b_imm_mem),
        base_clocks: 2,
    },
    common::PREFETCH_IRC_FINISH,
    common::BUS_WRITE_IDLE,
...
pub static STEPS_BCHG_STAT_D16_AN: [MicroStep; 10] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(latch_bit_imm),
        base_clocks: 2,
...
pub static STEPS_BCHG_STAT_IDX_AN: [MicroStep; 11] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(latch_bit_imm),
        base_clocks: 2,
...
pub const fn decode_bchg_dyn_steps(mode: u8, reg: u8) -> Option<&'static [MicroStep]> {
    match mode {
        ...
        5 => Some(&STEPS_BCHG_DYN_D16_AN),
        6 => Some(&STEPS_BCHG_DYN_IDX_AN),
        7 => match reg {
...
pub const fn decode_bchg_stat_steps(mode: u8, reg: u8) -> Option<&'static [MicroStep]> {
    match mode {
        ...
        5 => Some(&STEPS_BCHG_STAT_D16_AN),
        6 => Some(&STEPS_BCHG_STAT_IDX_AN),
        7 => match reg {
