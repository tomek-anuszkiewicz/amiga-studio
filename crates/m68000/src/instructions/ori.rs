...
pub static STEPS_ORI_B_DN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_ori_b_imm_dn), base_clocks: 4 },
...
pub static STEPS_ORI_B_AI: [MicroStep; 4] = [
    ...
    MicroStep { step_fn: Cpu::step_bus_prefetch_to_scratch, alu_fn: Some(alu_ori_b_mem), base_clocks: 4 },
...
pub static STEPS_ORI_W_DN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_ori_w_imm_dn), base_clocks: 4 },
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: None, base_clocks: 4 },
];
...
pub static STEPS_ORI_W_AI: [MicroStep; 4] = [
    ...
    MicroStep { step_fn: Cpu::step_bus_prefetch_to_scratch, alu_fn: Some(alu_ori_w_mem), base_clocks: 4 },
...
pub static STEPS_ORI_L_DN: [MicroStep; 4] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_ori_l_imm_dn), base_clocks: 4 },
];
...
pub static STEPS_ORI_L_AI: [MicroStep; 7] = [
    ...
    MicroStep { step_fn: Cpu::step_bus_prefetch_to_scratch, alu_fn: Some(alu_ori_l_mem), base_clocks: 4 },
