...
pub static STEPS_ORI_B_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_ori_b_imm_dn), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
...
pub static STEPS_ORI_B_AI: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_ori_b_mem), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
...
pub static STEPS_ORI_W_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_ori_w_imm_dn), base_clocks: 4, flags: flags::READ | flags::PROGRAM_SPACE },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: None, base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
];
...
pub static STEPS_ORI_W_AI: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_ori_w_mem), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
...
pub static STEPS_ORI_L_DN: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_ori_l_imm_dn), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
];
...
pub static STEPS_ORI_L_AI: [MicroStep; 7] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_ori_l_mem), base_clocks: 4, flags: flags::READ | flags::PREFETCH | flags::PROGRAM_SPACE },
...
pub static STEPS_ORI_CCR: [MicroStep; 1] = [MicroStep { action: MicroAction::OriToCcr, alu_fn: None, base_clocks: 0, flags: flags::NONE }];
pub static STEPS_ORI_SR: [MicroStep; 1] = [MicroStep { action: MicroAction::OriToSr, alu_fn: None, base_clocks: 0, flags: flags::NONE }];
...
pub fn op_ori_b_imm_absl(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_b_imm_absw(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_b_imm_ai(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_b_imm_ccr(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori_to_ccr(cpu, bus) }
pub fn op_ori_b_imm_disp(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_b_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_b_imm_idx(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_b_imm_pd(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_b_imm_pi(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }

pub fn op_ori_l_imm_absl(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_l_imm_absw(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_l_imm_ai(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_l_imm_disp(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_l_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_l_imm_idx(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_l_imm_pd(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_l_imm_pi(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }

pub fn op_ori_w_imm_absl(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_w_imm_absw(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_w_imm_ai(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_w_imm_disp(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_w_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_w_imm_idx(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_w_imm_pd(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_w_imm_pi(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori(cpu, bus) }
pub fn op_ori_w_imm_sr(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_ori_to_sr(cpu, bus) }
