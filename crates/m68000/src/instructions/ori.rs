...
pub static STEPS_ORI_B_DN: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(alu_ori_b_imm_dn), base_clocks: 2 },
...
pub static STEPS_ORI_B_AI: [MicroStep; 8] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_scratch_read, alu_fn: Some(alu_ori_b_mem), base_clocks: 2 },
...
pub static STEPS_ORI_B_D16: [MicroStep; 10] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_b), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_ORI_B_IDX: [MicroStep; 11] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_b), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_ORI_W_DN: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(alu_ori_w_imm_dn), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
...
pub static STEPS_ORI_W_AI: [MicroStep; 8] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_scratch_read, alu_fn: Some(alu_ori_w_mem), base_clocks: 2 },
    common::PREFETCH_SCRATCH_FINISH,
    common::BUS_WRITE_IDLE,
...
pub static STEPS_ORI_W_D16: [MicroStep; 10] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_w), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_dst_d16_an), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_ORI_W_IDX: [MicroStep; 11] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_w), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_dst_idx_an), base_clocks: 2 },
    common::FETCH_EXT_READ,
...
pub static STEPS_ORI_L_DN: [MicroStep; 7] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_ori_l_imm_dn), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];
...
pub static STEPS_ORI_L_AI: [MicroStep; 14] = [
    ...
    common::READ_WORD_FINISH,
    MicroStep { step_fn: Cpu::step_prefetch_scratch_read, alu_fn: Some(alu_ori_l_mem), base_clocks: 2 },
    common::PREFETCH_SCRATCH_FINISH,
    common::BUS_WRITE_IDLE,
...
pub static STEPS_ORI_L_D16: [MicroStep; 16] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_l_lo), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_ORI_L_IDX: [MicroStep; 17] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_l_lo), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_ORI_CCR: [MicroStep; 1] = [MicroStep { step_fn: crate::instructions::system::op_ori_to_ccr, alu_fn: None, base_clocks: 0 }];
pub static STEPS_ORI_SR: [MicroStep; 1] = [MicroStep { step_fn: crate::instructions::system::op_ori_to_sr, alu_fn: None, base_clocks: 0 }];
