...
pub fn op_addi(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    ...
    exec_addi(cpu, bus, s, m)
}

#[inline(always)]
fn exec_addi(cpu: &mut Cpu, bus: &mut MemoryBus, s: u8, m: u8) -> StepResult {
    ...
    if m == EA_DN {
        ...
        if s == SIZE_LONG {
            if phase == 0 {
                ...
                let res = execute_add(&mut cpu.state, imm, mem_val, Size::Long, true);
...
pub fn op_addi_b_imm_absl(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_b_imm_absw(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_b_imm_ai(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_b_imm_disp(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_b_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_b_imm_idx(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_b_imm_pd(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_b_imm_pi(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_l_imm_absl(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_l_imm_absw(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_l_imm_ai(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_l_imm_disp(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_l_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_l_imm_idx(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_l_imm_pd(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_l_imm_pi(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_w_imm_absl(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_w_imm_absw(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_w_imm_ai(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_w_imm_disp(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_w_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_w_imm_idx(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_w_imm_pd(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}

pub fn op_addi_w_imm_pi(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    op_addi(cpu, bus)
}
