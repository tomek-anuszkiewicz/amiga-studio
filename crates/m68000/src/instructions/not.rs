...
pub static STEPS_NOT_B_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_not_b_dn), base_clocks: 4 },
];
pub static STEPS_NOT_B_AI: [MicroStep; 3] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_not_b_mem), base_clocks: 4 },
...
pub static STEPS_NOT_W_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_not_w_dn), base_clocks: 4 },
];
pub static STEPS_NOT_W_AI: [MicroStep; 3] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_not_w_mem), base_clocks: 4 },
...
pub static STEPS_NOT_L_DN: [MicroStep; 2] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_not_l_dn), base_clocks: 4 },
];
pub static STEPS_NOT_L_AI: [MicroStep; 5] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_not_l_mem), base_clocks: 4 },
