...
pub static STEPS_OR_B_DN_DN: [MicroStep; 1] = [
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_or_b_dn_dn), base_clocks: 4 },
];
pub static STEPS_OR_B_AI_DN: [MicroStep; 2] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_or_b_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_OR_B_IMM_DN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_or_b_imm_dn), base_clocks: 4 },
...
pub static STEPS_OR_W_DN_DN: [MicroStep; 1] = [
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_or_w_dn_dn), base_clocks: 4 },
];
pub static STEPS_OR_W_AN_DN: [MicroStep; 1] = [
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_or_w_an_dn), base_clocks: 4 },
];
pub static STEPS_OR_W_AI_DN: [MicroStep; 2] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_or_w_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_OR_W_IMM_DN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_or_w_imm_dn), base_clocks: 4 },
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: None, base_clocks: 4 },
];
...
pub static STEPS_OR_L_DN_DN: [MicroStep; 2] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_or_l_dn_dn), base_clocks: 4 },
];
pub static STEPS_OR_L_AN_DN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: None, base_clocks: 4 },
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_or_l_an_dn), base_clocks: 4 },
];
pub static STEPS_OR_L_AI_DN: [MicroStep; 3] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_or_l_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_OR_B_DN_AI: [MicroStep; 3] = [
    ...
    MicroStep { step_fn: Cpu::step_bus_prefetch_to_scratch, alu_fn: Some(alu_or_b_dn_mem), base_clocks: 4 },
...
pub static STEPS_OR_W_DN_AI: [MicroStep; 3] = [
    ...
    MicroStep { step_fn: Cpu::step_bus_prefetch_to_scratch, alu_fn: Some(alu_or_w_dn_mem), base_clocks: 4 },
...
pub static STEPS_OR_L_DN_AI: [MicroStep; 5] = [
    ...
    MicroStep { step_fn: Cpu::step_bus_read_long_low, alu_fn: None, base_clocks: 4 },
    MicroStep { step_fn: Cpu::step_bus_prefetch_to_scratch, alu_fn: Some(alu_or_l_dn_mem), base_clocks: 4 },
