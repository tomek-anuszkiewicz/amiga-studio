...
pub static STEPS_OR_B_DN_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_or_b_dn_dn), base_clocks: 4 },
];
pub static STEPS_OR_B_AI_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::BusReadByte, alu_fn: Some(ea::ea_calc_src_ai), base_clocks: 4 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_or_b_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_OR_B_PD_DN: [MicroStep; 3] = [
    MicroStep { action: MicroAction::Alu, alu_fn: Some(ea::ea_calc_src_pd_b), base_clocks: 2 },
...
pub static STEPS_OR_B_IMM_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_or_b_imm_dn), base_clocks: 4 },
...
pub static STEPS_OR_W_DN_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_or_w_dn_dn), base_clocks: 4 },
];
pub static STEPS_OR_W_AN_DN: [MicroStep; 1] = [
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_or_w_an_dn), base_clocks: 4 },
];
pub static STEPS_OR_W_AI_DN: [MicroStep; 2] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_or_w_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_OR_W_IMM_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_or_w_imm_dn), base_clocks: 4 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: None, base_clocks: 4 },
];
...
pub static STEPS_OR_L_DN_DN: [MicroStep; 2] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_or_l_dn_dn), base_clocks: 4 },
];
pub static STEPS_OR_L_AN_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: None, base_clocks: 4 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_or_l_an_dn), base_clocks: 4 },
];
pub static STEPS_OR_L_AI_DN: [MicroStep; 3] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_or_l_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_OR_B_DN_AI: [MicroStep; 3] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_or_b_dn_mem), base_clocks: 4 },
...
pub static STEPS_OR_W_DN_AI: [MicroStep; 3] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_or_w_dn_mem), base_clocks: 4 },
...
pub static STEPS_OR_L_DN_AI: [MicroStep; 5] = [
    ...
    MicroStep { action: MicroAction::BusReadLongLow, alu_fn: None, base_clocks: 4 },
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_or_l_dn_mem), base_clocks: 4 },
