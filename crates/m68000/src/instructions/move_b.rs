...
const READ_OP: MicroStep = MicroStep { step_fn: Cpu::step_bus_read_byte, alu_fn: None, base_clocks: 4 };
const WRITE_OP: MicroStep = MicroStep { step_fn: Cpu::step_bus_write_byte, alu_fn: None, base_clocks: 4 };
const WRITE_OP_RETIRE: MicroStep = MicroStep { step_fn: Cpu::step_bus_write_byte_and_retire, alu_fn: None, base_clocks: 4 };
...
pub static STEPS_MOVE_B_DN_DN: [MicroStep; 1] = [
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_move_b_dn_dn), base_clocks: 4 },
];
...
pub static STEPS_MOVE_B_DN_D16: [MicroStep; 4] = [
    MicroStep::alu(alu_move_b_src_dn), MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(ea::ea_calc_dst_d16_an), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_DN_IDX: [MicroStep; 5] = [
    MicroStep::alu(alu_move_b_src_dn), MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_dst_idx_an), base_clocks: 2 },
    FETCH_EXT, WRITE_OP,
    PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_DN_ABSW: [MicroStep; 4] = [
    MicroStep::alu(alu_move_b_src_dn), MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(ea::ea_calc_absw), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_DN_ABSL: [MicroStep; 5] = [
    MicroStep::alu(alu_move_b_src_dn), MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(ea::ea_calc_absl_hi), base_clocks: 4 },
...
pub static STEPS_MOVE_B_AI_DN: [MicroStep; 3] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_move_b_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_MOVE_B_AI_D16: [MicroStep; 6] = [
    MicroStep::alu(ea::ea_calc_src_ai), READ_OP,
    MicroStep::alu(alu_move_b_src_mem), MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(ea::ea_calc_dst_d16_an), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_AI_IDX: [MicroStep; 7] = [
    MicroStep::alu(ea::ea_calc_src_ai), READ_OP,
    MicroStep::alu(alu_move_b_src_mem), MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_dst_idx_an), base_clocks: 2 },
    FETCH_EXT, WRITE_OP,
    PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_AI_ABSW: [MicroStep; 6] = [
    MicroStep::alu(ea::ea_calc_src_ai), READ_OP,
    MicroStep::alu(alu_move_b_src_mem), MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(ea::ea_calc_absw), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_AI_ABSL: [MicroStep; 7] = [
    MicroStep::alu(ea::ea_calc_src_ai), READ_OP,
    MicroStep::alu(alu_move_b_src_mem), MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(ea::ea_calc_absl_hi), base_clocks: 4 },
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(ea::ea_calc_absl_lo), base_clocks: 4 }, WRITE_OP,
    PREFETCH_RETIRE,
];
...
pub static STEPS_MOVE_B_PD_DN: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_src_pd_b), base_clocks: 2 }, READ_OP,
    MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_move_b_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_MOVE_B_IDX_DN: [MicroStep; 4] = [
    ...
    READ_OP, MicroStep { step_fn: Cpu::step_prefetch_next_opcode_and_retire, alu_fn: Some(alu_move_b_mem_dn), base_clocks: 4 },
];
...
pub static STEPS_MOVE_B_IMM_DN: [MicroStep; 2] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_move_b_imm_dn), base_clocks: 4 }, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_IMM_AI: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_move_b_src_imm), base_clocks: 4 }, MicroStep::alu(ea::ea_calc_dst_ai),
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_IMM_PI: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_move_b_src_imm), base_clocks: 4 }, MicroStep::alu(ea::ea_calc_dst_pi_b),
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_IMM_PD: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_move_b_src_imm), base_clocks: 4 }, MicroStep::alu(ea::ea_calc_dst_pd_b),
    PREFETCH_SCRATCH, WRITE_OP_RETIRE,
];
pub static STEPS_MOVE_B_IMM_D16: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_move_b_src_imm), base_clocks: 4 }, MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(ea::ea_calc_dst_d16_an), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_IMM_IDX: [MicroStep; 5] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_move_b_src_imm), base_clocks: 4 }, MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_dst_idx_an), base_clocks: 2 },
    FETCH_EXT, WRITE_OP,
    PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_IMM_ABSW: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_move_b_src_imm), base_clocks: 4 }, MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(ea::ea_calc_absw), base_clocks: 4 },
    WRITE_OP, PREFETCH_RETIRE,
];
pub static STEPS_MOVE_B_IMM_ABSL: [MicroStep; 5] = [
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(alu_move_b_src_imm), base_clocks: 4 }, MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(ea::ea_calc_absl_hi), base_clocks: 4 },
    MicroStep { step_fn: Cpu::step_fetch_extension, alu_fn: Some(ea::ea_calc_absl_lo), base_clocks: 4 }, WRITE_OP,
    PREFETCH_RETIRE,
];
