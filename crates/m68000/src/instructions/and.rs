...
pub static STEPS_AND_B_D16_AN_DN: [MicroStep; 6] = [
    MicroStep {
...
pub static STEPS_AND_B_IDX_AN_DN: [MicroStep; 7] = [
    MicroStep {
        step_fn: None,
...
pub static STEPS_AND_B_D16_PC_DN: [MicroStep; 6] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
...
pub static STEPS_AND_B_IDX_PC_DN: [MicroStep; 7] = [
    MicroStep {
        step_fn: None,
...
// ============================================================================
// Static Micro-Step Slices: AND <ea>, Dn (Word)
// ============================================================================

pub static STEPS_AND_W_DN_DN: [MicroStep; 2] = [
    MicroStep {
        step_fn: Some(Cpu::step_prefetch_next_read),
        alu_fn: Some(alu_and_w_dn_dn),
        base_clocks: 2,
    },
    common::BUS_READ_IDLE,
];
...
pub static STEPS_AND_W_D16_AN_DN: [MicroStep; 6] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_src_d16_an),
        base_clocks: 2,
...
pub static STEPS_AND_W_IDX_AN_DN: [MicroStep; 7] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_idx_an),
        base_clocks: 2,
...
pub static STEPS_AND_W_D16_PC_DN: [MicroStep; 6] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_d16_pc),
        base_clocks: 2,
...
pub static STEPS_AND_W_IDX_PC_DN: [MicroStep; 7] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_idx_pc),
        base_clocks: 2,
...
// ============================================================================
// Static Micro-Step Slices: AND <ea>, Dn (Long)
// ============================================================================
...
pub static STEPS_AND_L_D16_AN_DN: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_src_d16_an),
        base_clocks: 2,
...
pub static STEPS_AND_L_IDX_AN_DN: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_src_idx_an),
        base_clocks: 2,
...
pub static STEPS_AND_L_D16_PC_DN: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_d16_pc),
        base_clocks: 2,
...
pub static STEPS_AND_L_IDX_PC_DN: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_idx_pc),
        base_clocks: 2,
...
pub static STEPS_AND_L_IMM_DN: [MicroStep; 6] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
...
pub const fn decode_and_ea_dn_steps(size: u8, mode: u8, reg: u8) -> Option<&'static [MicroStep]> {
    match size {
        0 => match mode {
            ...
            5 => Some(&STEPS_AND_B_D16_AN_DN),
            6 => Some(&STEPS_AND_B_IDX_AN_DN),
            7 => match reg {
                0 => Some(&STEPS_AND_B_ABSW_DN),
                1 => Some(&STEPS_AND_B_ABSL_DN),
                2 => Some(&STEPS_AND_B_D16_PC_DN),
                3 => Some(&STEPS_AND_B_IDX_PC_DN),
        ...
        1 => match mode {
            ...
            5 => Some(&STEPS_AND_W_D16_AN_DN),
            6 => Some(&STEPS_AND_W_IDX_AN_DN),
            7 => match reg {
                0 => Some(&STEPS_AND_W_ABSW_DN),
                1 => Some(&STEPS_AND_W_ABSL_DN),
                2 => Some(&STEPS_AND_W_D16_PC_DN),
                3 => Some(&STEPS_AND_W_IDX_PC_DN),
        ...
        2 => match mode {
            ...
            5 => Some(&STEPS_AND_L_D16_AN_DN),
            6 => Some(&STEPS_AND_L_IDX_AN_DN),
            7 => match reg {
                0 => Some(&STEPS_AND_L_ABSW_DN),
                1 => Some(&STEPS_AND_L_ABSL_DN),
                2 => Some(&STEPS_AND_L_D16_PC_DN),
                3 => Some(&STEPS_AND_L_IDX_PC_DN),
...
// Static Micro-Step Slices: AND Dn, <ea> (Byte RMW)
// ============================================================================
...
pub static STEPS_AND_B_DN_D16_AN: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
...
pub static STEPS_AND_B_DN_IDX_AN: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
...
// ============================================================================
// Static Micro-Step Slices: AND Dn, <ea> (Word RMW)
// ============================================================================
...
pub static STEPS_AND_W_DN_D16_AN: [MicroStep; 8] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_dst_d16_an),
        base_clocks: 2,
...
pub static STEPS_AND_W_DN_IDX_AN: [MicroStep; 9] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_dst_idx_an),
        base_clocks: 2,
...
// ============================================================================
// Static Micro-Step Slices: AND Dn, <ea> (Long RMW)
// ============================================================================
...
pub static STEPS_AND_L_DN_D16_AN: [MicroStep; 12] = [
    MicroStep {
        step_fn: Some(Cpu::step_fetch_extension_read),
        alu_fn: Some(ea::ea_calc_dst_d16_an),
        base_clocks: 2,
...
pub static STEPS_AND_L_DN_IDX_AN: [MicroStep; 13] = [
    MicroStep {
        step_fn: None,
        alu_fn: Some(ea::ea_calc_dst_idx_an),
        base_clocks: 2,
...
pub const fn decode_and_dn_ea_steps(size: u8, mode: u8, reg: u8) -> Option<&'static [MicroStep]> {
    match size {
        0 => match mode {
            2 => Some(&STEPS_AND_B_DN_AI),
            3 => Some(&STEPS_AND_B_DN_PI),
            4 => Some(&STEPS_AND_B_DN_PD),
            5 => Some(&STEPS_AND_B_DN_D16_AN),
            6 => Some(&STEPS_AND_B_DN_IDX_AN),
            7 => match reg {
        ...
        1 => match mode {
            ...
            5 => Some(&STEPS_AND_W_DN_D16_AN),
            6 => Some(&STEPS_AND_W_DN_IDX_AN),
            7 => match reg {
        ...
        2 => match mode {
            ...
            5 => Some(&STEPS_AND_L_DN_D16_AN),
            6 => Some(&STEPS_AND_L_DN_IDX_AN),
            7 => match reg {
...
pub const fn decode_and_steps(
    ...
    if dir == 0 {
        decode_and_ea_dn_steps(size, mode, reg)
    } else {
        decode_and_dn_ea_steps(size, mode, reg)
    }
}
