...
pub static STEPS_ASL_B_IMM: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: Some(alu_asl_b_imm_dn), base_clocks: 0, flags: 0 },
    common::RETIRE_STANDARD,
];
pub static STEPS_ASL_W_IMM: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: Some(alu_asl_w_imm_dn), base_clocks: 0, flags: 0 },
    common::RETIRE_STANDARD,
];
pub static STEPS_ASL_L_IMM: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: Some(alu_asl_l_imm_dn), base_clocks: 0, flags: 0 },
    common::RETIRE_STANDARD,
];

pub static STEPS_ASL_B_REG: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: Some(alu_asl_b_reg_dn), base_clocks: 0, flags: 0 },
    common::RETIRE_STANDARD,
];
pub static STEPS_ASL_W_REG: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: Some(alu_asl_w_reg_dn), base_clocks: 0, flags: 0 },
    common::RETIRE_STANDARD,
];
pub static STEPS_ASL_L_REG: [MicroStep; 2] = [
    MicroStep { action: MicroAction::Alu, alu_fn: Some(alu_asl_l_reg_dn), base_clocks: 0, flags: 0 },
    common::RETIRE_STANDARD,
];
...
pub static STEPS_ASL_W_D16: [MicroStep; 4] = [
...
pub static STEPS_ASL_W_IDX: [MicroStep; 5] = [
...
pub static STEPS_ASL_W_ABSW: [MicroStep; 4] = [
...
pub static STEPS_ASL_W_ABSL: [MicroStep; 5] = [
...
pub fn op_asl_reg(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    crate::micro::engine::execute_micro_step(cpu, bus)
}

pub fn op_asl_mem(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult {
    crate::micro::engine::execute_micro_step(cpu, bus)
}

pub fn op_asl_b_dn_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_reg(cpu, bus) }
pub fn op_asl_b_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_reg(cpu, bus) }
pub fn op_asl_l_dn_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_reg(cpu, bus) }
pub fn op_asl_l_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_reg(cpu, bus) }
pub fn op_asl_w_dn_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_reg(cpu, bus) }
pub fn op_asl_w_imm_dn(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_reg(cpu, bus) }

pub fn op_asl_w_absl(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_mem(cpu, bus) }
pub fn op_asl_w_absw(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_mem(cpu, bus) }
pub fn op_asl_w_ai(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_mem(cpu, bus) }
pub fn op_asl_w_disp(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_mem(cpu, bus) }
pub fn op_asl_w_idx(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_mem(cpu, bus) }
pub fn op_asl_w_pd(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_mem(cpu, bus) }
pub fn op_asl_w_pi(cpu: &mut Cpu, bus: &mut MemoryBus) -> StepResult { op_asl_mem(cpu, bus) }
