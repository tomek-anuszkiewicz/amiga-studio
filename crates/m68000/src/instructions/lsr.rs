...
pub static STEPS_LSR_B_IMM: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_lsr_b_imm_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_LSR_W_IMM: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_lsr_w_imm_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_LSR_L_IMM: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_lsr_l_imm_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];

pub static STEPS_LSR_B_REG: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_lsr_b_reg_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_LSR_W_REG: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_lsr_w_reg_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
pub static STEPS_LSR_L_REG: [MicroStep; 3] = [
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(alu_lsr_l_reg_dn), base_clocks: 0 },
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];
...
pub static STEPS_LSR_W_PD: [MicroStep; 6] = [
...
pub static STEPS_LSR_W_D16: [MicroStep; 8] = [
...
pub static STEPS_LSR_W_IDX: [MicroStep; 9] = [
...
pub static STEPS_LSR_W_ABSW: [MicroStep; 8] = [
...
pub static STEPS_LSR_W_ABSL: [MicroStep; 10] = [
