...
pub static STEPS_SUBI_B_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_subi_b_imm_dn), base_clocks: 4 },
...
pub static STEPS_SUBI_B_AI: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_subi_b_mem), base_clocks: 4 },
...
pub static STEPS_SUBI_W_DN: [MicroStep; 2] = [
    MicroStep { action: MicroAction::FetchExtension, alu_fn: Some(alu_subi_w_imm_dn), base_clocks: 4 },
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: None, base_clocks: 4 },
];
...
pub static STEPS_SUBI_W_AI: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_subi_w_mem), base_clocks: 4 },
...
pub static STEPS_SUBI_L_DN: [MicroStep; 4] = [
    ...
    MicroStep { action: MicroAction::PrefetchNextOpcodeAndRetire, alu_fn: Some(alu_subi_l_imm_dn), base_clocks: 4 },
];
...
pub static STEPS_SUBI_L_AI: [MicroStep; 7] = [
    ...
    MicroStep { action: MicroAction::BusPrefetchToScratch, alu_fn: Some(alu_subi_l_mem), base_clocks: 4 },
