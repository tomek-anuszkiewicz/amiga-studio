...
pub static STEPS_SUBI_B_DN: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(alu_subi_b_imm_dn), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];

pub static STEPS_SUBI_B_AI: [MicroStep; 8] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_scratch_read, alu_fn: Some(alu_subi_b_mem), base_clocks: 2 },
    common::PREFETCH_SCRATCH_FINISH,
    common::BUS_WRITE_IDLE,
    common::WRITE_DST_BYTE_RETIRE,
];

pub static STEPS_SUBI_B_PI: [MicroStep; 8] = [
...
pub static STEPS_SUBI_B_PD: [MicroStep; 9] = [
...
pub static STEPS_SUBI_B_D16: [MicroStep; 10] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_b), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_B_IDX: [MicroStep; 11] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_b), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_B_ABSW: [MicroStep; 10] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_b), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_B_ABSL: [MicroStep; 12] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_b), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_W_DN: [MicroStep; 4] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(alu_subi_w_imm_dn), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    common::PREFETCH_NEXT_READ,
    common::PREFETCH_NEXT_RETIRE,
];

pub static STEPS_SUBI_W_AI: [MicroStep; 8] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_scratch_read, alu_fn: Some(alu_subi_w_mem), base_clocks: 2 },
    common::PREFETCH_SCRATCH_FINISH,
    common::BUS_WRITE_IDLE,
    common::WRITE_DST_WORD_RETIRE,
];

pub static STEPS_SUBI_W_PI: [MicroStep; 8] = [
...
pub static STEPS_SUBI_W_PD: [MicroStep; 9] = [
...
pub static STEPS_SUBI_W_D16: [MicroStep; 10] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_w), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_dst_d16_an), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_W_IDX: [MicroStep; 11] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_w), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_alu, alu_fn: Some(ea::ea_calc_dst_idx_an), base_clocks: 2 },
    common::FETCH_EXT_READ,
...
pub static STEPS_SUBI_W_ABSW: [MicroStep; 10] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_w), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_absw), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_W_ABSL: [MicroStep; 12] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_w), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_absl_hi), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_L_DN: [MicroStep; 7] = [
    ...
    MicroStep { step_fn: Cpu::step_prefetch_next_read, alu_fn: Some(alu_subi_l_imm_dn), base_clocks: 2 },
    common::PREFETCH_NEXT_RETIRE,
];

pub static STEPS_SUBI_L_AI: [MicroStep; 14] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    ...
    common::READ_WORD_FINISH,
    MicroStep { step_fn: Cpu::step_prefetch_scratch_read, alu_fn: Some(alu_subi_l_mem), base_clocks: 2 },
    common::PREFETCH_SCRATCH_FINISH,
    common::BUS_WRITE_IDLE,
...
pub static STEPS_SUBI_L_PI: [MicroStep; 14] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_L_PD: [MicroStep; 15] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_L_D16: [MicroStep; 16] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_l_lo), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_L_IDX: [MicroStep; 17] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_l_lo), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_L_ABSW: [MicroStep; 16] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_l_lo), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
...
pub static STEPS_SUBI_L_ABSL: [MicroStep; 18] = [
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(ea::ea_calc_imm_l_hi), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
    MicroStep { step_fn: Cpu::step_fetch_extension_read, alu_fn: Some(crate::instructions::addi::latch_imm_l_lo), base_clocks: 2 },
    common::FETCH_EXT_FINISH,
