...
fn test_blitter_copy_and_interrupt_propagation() {
    ...
    harness.machine.write_custom_word(0x096, 0x8240);
    ...
    harness.machine.write_custom_word(0x040, 0x09F0);
    // BLTCON1 ($042): 0
    harness.machine.write_custom_word(0x042, 0x0000);
    // BLTAFWM / BLTALWM ($044 / $046): $FFFF
    harness.machine.write_custom_word(0x044, 0xFFFF);
    harness.machine.write_custom_word(0x046, 0xFFFF);
    // Modulos ($064, $066): 0
    harness.machine.write_custom_word(0x064, 0x0000);
    harness.machine.write_custom_word(0x066, 0x0000);
    // BLTAPTH / BLTAPTL ($050 / $052)
    harness
        .machine
        .write_custom_word(0x050, (src_addr >> 16) as u16);
    harness
        .machine
        .write_custom_word(0x052, (src_addr & 0xFFFF) as u16);
    // BLTDPTH / BLTDPTL ($054 / $056)
    harness
        .machine
        .write_custom_word(0x054, (dst_addr >> 16) as u16);
    harness
        .machine
        .write_custom_word(0x056, (dst_addr & 0xFFFF) as u16);
    ...
    harness.machine.write_custom_word(0x058, 0x0104);
    harness.step_cck(2);
...
fn test_blitter_fill_operation_mutates_ram() {
    ...
    harness.machine.write_custom_word(0x040, 0x01FF);
    harness.machine.write_custom_word(0x042, 0x0000);
    harness.machine.write_custom_word(0x066, 0x0000); // D modulo = 0
    harness
        .machine
        .write_custom_word(0x054, (dst_addr >> 16) as u16);
    harness
    ...
    harness.machine.write_custom_word(0x058, 0x0084);
    harness.step_cck(2);
