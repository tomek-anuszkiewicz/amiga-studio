...
fn create_primed_app() -> EmulatorApp {
    ...
    app.session.cpu.state.set_d_long(0, 0xCAFE_BABE);
    app.session.cpu.state.set_d_long(1, 0x0000_1000);
    app.session.cpu.state.set_a_long(0, 0x0000_2000);
    app.session.cpu.state.sr = 0x2700;
