...
//! `.retrosh` script parsing, test catalog categorization, and golden 716 x 285 RGB24
//! reference frame comparisons against physical silicon test captures.
...
pub use catalog::{
    CatalogStats, DeferredReason, VamigaCatalog, VamigaCategory, VamigaTestDescriptor,
    VamigaTestStatus,
};
pub use injector::{
...
pub use runner::{
    run_vamiga_suite, run_vamiga_test, run_vamiga_test_buffers, run_vamiga_test_from_dir,
    VamigaRunConfig, VamigaSuiteSummary,
};
pub use script::VamigaScript;
