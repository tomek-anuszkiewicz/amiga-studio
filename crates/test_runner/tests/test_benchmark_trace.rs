...
pub const GOLDEN_TRACE_HASHES: &[(&str, u64)] = &[
    ...
    ("MOV-16", 0x10E47FF8F8F74E15),
    ("MOV-17", 0xCDB9D30700714CDE),
    ("MOV-18", 0x7866B95FCF372EF7),
    ("MOV-19", 0x71DE887AEE49C70B),
    ("MOV-20", 0x20DD947DCFEE8E98),
    ("MOV-21", 0xA017880E696C8D43),
    ...
    ("SHIFT-01", 0xAEEA8ADBED596D78),
    ("SHIFT-02", 0x2DEDA21150D374AB),
    ("SHIFT-03", 0xB5BC229C7AAD96AE),
    ("SHIFT-04", 0x23984DD80B68C427),
    ("SHIFT-05", 0x1F6573AFC16603C6),
    ("SHIFT-06", 0x110330F19F5C4D40),
    ("SHIFT-07", 0x2D7694A51820A9AF),
        ...
        if actual_hash != expected_hash {
            failures.push(format!(
                "\n⛔ CRITICAL REGRESSION: TRACE HASH MISMATCH for [{}] ({})\n\
                   ...
                   3. Fix the underlying regression in crates/m68000/ or crates/memory_bus/.\n",
