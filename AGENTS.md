...
- **Milestone Gates:** Run [`compact-diary`](.agents/skills/compact-diary/SKILL.md) and [`audit-all`](.agents/skills/audit-all/SKILL.md) (or [`audit-code-quality`](.agents/skills/audit-code-quality/SKILL.md), [`audit-docs-quality`](.agents/skills/audit-docs-quality/SKILL.md), [`audit-hardware-quality`](.agents/skills/audit-hardware-quality/SKILL.md)) upon major milestone completion.
