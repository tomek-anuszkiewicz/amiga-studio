...
- **Milestone Gates:** Run [`compact-diary`](.agents/skills/compact-diary/SKILL.md), [`audit-code-quality`](.agents/skills/audit-code-quality/SKILL.md), [`audit-docs-quality`](.agents/skills/audit-docs-quality/SKILL.md), and [`audit-hardware-quality`](.agents/skills/audit-hardware-quality/SKILL.md) upon major milestone completion.
