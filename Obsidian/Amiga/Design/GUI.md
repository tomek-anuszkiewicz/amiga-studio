...
When developer mode is enabled, the GUI displays interactive debugger tool windows powered by [Debugger.md](file:///d:/Programowanie/Amiga/Obsidian/Amiga/Design/Debugger.md):
