...
- **Living Tooling Implementations:** [`tools/bootstrap/bootstrap.ps1`](../../../tools/bootstrap/bootstrap.ps1) | [`tools/bootstrap/bootstrap_sources.ps1`](../../../tools/bootstrap/bootstrap_sources.ps1) | [`tools/bootstrap/bootstrap_graphify.ps1`](../../../tools/bootstrap/bootstrap_graphify.ps1) | [`tools/bootstrap/bootstrap_rag.ps1`](../../../tools/bootstrap/bootstrap_rag.ps1) | [`tools/bootstrap/bootstrap_documentation.ps1`](../../../tools/bootstrap/bootstrap_documentation.ps1) | [`amiga_rag_mcp_server.py`](../../../tools/amiga-rag-mcp-server/amiga_rag_mcp_server.py)
...
- **Tooling Implementations:**
  - [`tools/bootstrap/bootstrap.ps1`](../../../tools/bootstrap/bootstrap.ps1): Multi-tier repository bootstrap coordinator.
  - [`tools/bootstrap/bootstrap_sources.ps1`](../../../tools/bootstrap/bootstrap_sources.ps1): External test sources, hardware vectors, and reference emulator bootstrapper.
  - [`tools/bootstrap/bootstrap_graphify.ps1`](../../../tools/bootstrap/bootstrap_graphify.ps1): AST code knowledge graph bootstrapper.
  - [`tools/bootstrap/bootstrap_rag.ps1`](../../../tools/bootstrap/bootstrap_rag.ps1): AI documentation knowledge base and Qdrant vector index bootstrapper.
  - [`tools/bootstrap/bootstrap_documentation.ps1`](../../../tools/bootstrap/bootstrap_documentation.ps1): Multi-mirror reference documentation fetcher and crawler.
  - [`amiga_rag_mcp_server.py`](../../../tools/amiga-rag-mcp-server/amiga_rag_mcp_server.py): FastMCP adapter that invokes `rag_qdrant` from `PATH`.
- **Upstream Standards:**
