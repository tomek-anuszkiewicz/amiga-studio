...
- [vAmiga Copper Component Implementation](../../../ref_src/vAmiga/Core/Components/Agnus/Copper/Copper.cpp): Cycle-exact state machine model for Copper instruction decode, comparator logic, and DMA slot fetches.
- [vAmiga Blitter Component Implementation](../../../ref_src/vAmiga/Core/Components/Agnus/Blitter/Blitter.cpp): Reference pipeline implementation for multi-channel DMA blits, shift logic, and mask application.
