...
| **Anomaly Engine Tests** | [`crates/test_runner/tests/anomaly.rs`](../../../crates/test_runner/tests/anomaly.rs) | Unit tests for Type A/B/C anomalies, timeout verdicts, baseline delta percentages, and regression statuses. |
| **Statistical Analysis Tests** | [`crates/test_runner/tests/stats.rs`](../../../crates/test_runner/tests/stats.rs) | Unit tests for Tukey's outlier fences, percentiles, trimmed means, jitter CV, and nominal total_ops invariance. |
| **Platform Abstraction Tests** | [`crates/test_runner/tests/platform.rs`](../../../crates/test_runner/tests/platform.rs) | Unit tests for host CPU topology detection, platform naming, and P-core affinity pinning without panics. |
| **Results Persistence Tests** | [`crates/test_runner/tests/persistence.rs`](../../../crates/test_runner/tests/persistence.rs) | Unit tests for timestamp formatting, JSON/CSV roundtrips, baseline loading, and canonical file overwriting. |
| **Program Builder Tests** | [`crates/test_runner/tests/builder.rs`](../../../crates/test_runner/tests/builder.rs) | Unit tests for unroll factors, PRNG seeding, cyclic memory buffers, and CPU/bus injection across all 108 specs. |
| **Deterministic PRNG Tests** | [`crates/test_runner/tests/prng.rs`](../../../crates/test_runner/tests/prng.rs) | Validates PRNG seed determinism, BCD domain clamping, non-zero divisors, and buffer alignment. |
