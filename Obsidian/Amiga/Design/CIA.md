...
- [vAmiga CIA Component Implementation](../../../ref_src/vAmiga/Core/Components/CIA/CIA.cpp): Reference C++ state machine for 5-CCK E-Clock timing division, ICR set/clear masks, and TOD 50/60 Hz latching.
