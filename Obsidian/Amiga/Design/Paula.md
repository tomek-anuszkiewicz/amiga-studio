...
- [vAmiga Paula Component Implementation](../../../ref_src/vAmiga/Core/Components/Paula/Paula.cpp): Reference C++ coordinator for sound generation, interrupt routing, and UART framing.
