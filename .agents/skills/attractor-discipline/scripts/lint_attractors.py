...
Packaged within .agents/skills/attractor-discipline/scripts/lint_attractors.py.
...
ATTRACTOR_PATTERNS = [
    {
        ...
        "allow_files": ["lint_attractors.py", "DIARY.md", "test_architecture_rules.rs", "attractor-discipline.md", "SKILL.md"],  # Historical logs, linter, and rules/skills allowed
    },
    {
        ...
        "scope": ["Obsidian/Amiga/Design", ".agents/rules", ".agents/skills", "crates"],
        "allow_files": ["lint_attractors.py", "DIARY.md", "test_architecture_rules.rs", "attractor-discipline.md", "SKILL.md"],
    },
    {
