...
4. **End-to-End LLM Typography**: Typographical, spacing, and OCR kerning fixes are performed globally by LLM on the emitted Markdown rather than using brittle local regexes.
