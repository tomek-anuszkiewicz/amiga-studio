...
To keep documents clear and put key conclusions first, all design specifications must adhere to the **Inverted Pyramid model** ([`information-hierarchy.md`](information-hierarchy.md)) and maintain a direct, hands-on practitioner tone ([`practitioner-voice-and-tone.md`](practitioner-voice-and-tone.md)):
