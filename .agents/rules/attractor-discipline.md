...
1. **Autonomous Python Linter:** Packaged in [`attractor-discipline`](../skills/attractor-discipline/SKILL.md) skill at `.agents/skills/attractor-discipline/scripts/lint_attractors.py` (`python .agents/skills/attractor-discipline/scripts/lint_attractors.py`). Scans all `.md` and `.rs` files and supports `--fix`.
